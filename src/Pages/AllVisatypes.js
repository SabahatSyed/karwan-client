...
import AllUsersItems from "../Components/DisplayItems/AllVisaTypeItems";
...
const Users = () => {
  ...
  const { data: allVisas, isloading } = useFetch("/get-visatype", check);
    ...
    <Card>
      <div className="w-[90%] max-w-5xl h-full mx-auto">
        <header className="flex flex-col gap-2 justify-start mb-14 ">
          <h1 className="text-4xl">All Visa Types</h1>
        ...
        <div className="flex flex-col px-0">
          <div className="flex items-center justify-between">
            <p className="text-lg font-bold text-secondary">Visa Types</p>
            <svg
